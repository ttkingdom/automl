...
# ==============================================================================
r"""Convert ADCBook dataset to TFRecord.

Example usage:
    python create_adcbook_tfrecord.py  --data_dir=/tf/ADCBook  \
        --output_path=/tmp/adcbook
"""
...
flags.DEFINE_string('data_dir', '', 'Root directory to raw ADCBook dataset.')
...
def get_image_id(filename):
    ...
    # We are going to use an incremental global_id,
...
def main(_):
    ...
    if FLAGS.label_map_json_path:
        ...
        label_map_dict = adcbook_label_map_dict
